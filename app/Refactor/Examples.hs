...
-}
module Refactor.Examples where

import Data.Int (Int32, Int64)
import Refactor.Types
import Utils
import Refactor.Wasm
import Refactor.WasmInterpreter
import Refactor.WasmModule
...
executeAddStep =
    step
        ( RuntimeContext
            ...
            , locals = NoLocals
            , Refactor.WasmInterpreter.globals = Refactor.WasmInterpreter.NoGlobals
            , labels = NoLabels
            , memories = NoMems
            } ::
...
executeMemLoad =
    stepMany
        ( RuntimeContext
            ...
            , Refactor.WasmInterpreter.globals = Refactor.WasmInterpreter.NoGlobals
            , labels = NoLabels
            , memories = Refactor.WasmInterpreter.ConsMems currMem NoMems
            } ::
            RuntimeContext
                '[]
                '[I32, I32]
...
executeMemStore =
    stepMany
        ( RuntimeContext
            ...
            , Refactor.WasmInterpreter.globals = Refactor.WasmInterpreter.NoGlobals
            , labels = NoLabels
            , memories = Refactor.WasmInterpreter.ConsMems storeMem NoMems
            } ::
            RuntimeContext
                '[]
                '[I32, I32]
...
executeGlobalGetSetSequence =
    stepMany
        ( RuntimeContext
            { values = NoValues
            , locals = NoLocals
            , Refactor.WasmInterpreter.globals = Refactor.WasmInterpreter.ConsGlobals 5 SVar NoGlobals
            , labels = NoLabels
            , memories = NoMems
            } ::
            RuntimeContext
...
branchExample4 ::
    forall (s :: WasmModuleShape) (wm :: WasmModule s).
    (s ~ WasmModuleShapeR Z Z) => Function '[] (I32 ': '[]) (I32 ': '[]) '[] wm
